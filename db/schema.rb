...
ActiveRecord::Schema.define(version: 20_170_219_204_128) do
  ...
  create_table 'carriages', force: :cascade do |t|
    ...
    t.index %w(id type), name: 'index_carriages_on_id_and_type', using: :btree
  end
  ...
  create_table 'railway_stations_routes', force: :cascade do |t|
    ...
    t.integer 'number'
    t.integer 'order'
    t.time    'arrival_time',       default: '2000-01-01 16:48:35'
    t.time    'departure_time',     default: '2000-01-01 16:48:35'
  ...
  create_table 'trains', force: :cascade do |t|
    ...
    t.integer  'route_id'
    t.boolean  'carriage_order', default: false
